...
class TagSppurchase extends Base
{
    ...
    public function getSppurchase($currentclass = '')
    {
        ...
        $field = 'aid, title, channel, users_price, users_discount_type, old_price, stock_count, stock_show, sales_num, virtual_sales, sales_all, merchant_id';
        ...
        // 商品虚拟销量
        $result['sales_num'] = $archivesInfo['sales_num'] = $archivesInfo['sales_all'];
        // 商品总虚拟销量
        $result['sales_all'] = $archivesInfo['sales_all'];
        // 规格价格、规格选中ID组合
